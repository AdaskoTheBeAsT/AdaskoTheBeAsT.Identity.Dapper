...
CREATE TABLE mydeveloper.ASPNETROLES (
    ...
    NormalizedName   VARCHAR2(256) NULL,
    ConcurrencyStamp VARCHAR2(256) NULL,
    PRIMARY KEY (Id)
);

CREATE UNIQUE INDEX RoleNameIndex
    ON mydeveloper.ASPNETROLES(NormalizedName ASC);
...
CREATE TABLE mydeveloper.ASPNETUSERS (
    ...
    NormalizedUserName   VARCHAR2(256)     NULL,
    Email                VARCHAR2(256)     NULL,
    NormalizedEmail      VARCHAR2(256)     NULL,
...
CREATE INDEX EmailIndex
    ON mydeveloper.ASPNETUSERS(NormalizedEmail ASC);
	
CREATE UNIQUE INDEX UserNameIndex
    ON mydeveloper.ASPNETUSERS(NormalizedUserName ASC);
